...
<thead>
                    ...
                    <?php
                     ...
                     $bulan_nama2 = gmdate('M', $waktu_indonesia);
                      ...
                      include "koneksi.php";
                      $no=1;
                      $ambildata = mysqli_query($koneksi,"SELECT DISTINCT cont,destination,dok FROM tb_va_input_exim_all WHERE jam_dami >='07:00:00'  and tgll ='$tanggal_ori'  ");
                          ...
                          <tr>
                                  ...
                                  <td><center><?php echo $tampil['cont']; ?></center></td>
                                  <td><center><?php echo $tampil['destination']; ?></center></td>
                                  <td><center>Dok&nbsp;<?php echo $tampil['dok']; ?></center></td>
...
{       
    ...
    $result = mysqli_query($koneksi, "UPDATE tb_va_total_container SET total_plan='$total_plan'");
}
?>
<?php
